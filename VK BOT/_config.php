...
const VK_KEY = ""; // EN: Group token with messages permission | RU: Токен группы с правами на сообщения
const VERSION = "5.131"; // EN: API version. Leave 5.131 for correct work | RU: Версия API. Оставь 5.131 для корректной работы
const CONFIRM_STR = ""; // EN: Confirmation String. | RU: Строка подтверждения
